        ...
        <Tabs>
              ...
              {tasks.map((task) => (
                <Task
                  ...
                  subTasks={
                    subTasks
                      ? subTasks
                          .filter((e) => e.parentID === task.id)
                          .map((subtask) => (
                            <Subtask
                              key={subtask.id}
                              subTask={subtask}
                              toggleSubCompletion={toggleSubCompletion}
                              updateSubTaskArray={updateSubTaskArray}
                              deleteSubTaskFromArray={deleteSubTaskFromArray}
                            />
                          ))
                      : "No subtasks"
                  }
          ...
          <TabPanel>
            ...
            <ProgressBar
              ...
              tasks={tasks.filter((e) => e.priority === "High")}
            />
            <ul className="list-group">
              {tasks
          ...
          <TabPanel>
            ...
            <ProgressBar
              ...
              tasks={tasks.filter((e) => e.priority === "Medium")}
            />
            <ul className="list-group">
              {tasks
          ...
          <TabPanel>
            ...
            <ProgressBar
              ...
              tasks={tasks.filter((e) => e.priority === "Low")}
            />
            <ul className="list-group">
              {tasks
